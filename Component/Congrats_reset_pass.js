...
class Congrats_reset_pass extends Component {
        ...
        return (
            <ImageBackground source={require('../Images/445660-blue-art-background-blue-wallpaper.jpg')} style={styles.image}>
                <View style={styles.footer}>
                    ...
                    <Text style={styles.text_footer}>your account password has been changed </Text>
                    <View style={styles.button}>
                            <TouchableOpacity
                                onPress={() => navigate("SignScreen")}>
                                <LinearGradient
...
export default Congrats_reset_pass;
