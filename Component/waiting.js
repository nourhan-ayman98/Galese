...
class Congrats_waiting extends Component {
        ...
        return (
            <ImageBackground source={require('../Images/445660-blue-art-background-blue-wallpaper.jpg')} style={styles.image}>
                <View style={styles.footer}>
                    ...
                    <Text style={styles.text_header}>Congratiolations your CV was sent Successfully </Text>
                    <Text style={styles.text_footer}>Please Wait For Reply</Text>
...
export default Congrats_waiting;
